...
def test_class_flat_rows_cover_every_candidate_exactly_once():
    ...
    """
    from relax.local.flat_local_rows import build_pool_flat_local_row_plan_for_classes
...
def test_bucket_stage_flat_plan_dispatches_on_class_segmented_buckets():
    ...
    from relax.local.flat_local_rows import build_pool_flat_local_row_plan
...
def test_packed_row_capacity_ladder_only_ever_rounds_up():
    ...
    from relax.local.flat_local_rows import quantize_packed_row_capacity
