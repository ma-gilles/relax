...
from relax.scoring.coarse_gaussian_gemm import CoarseGaussianGemmHybridBatchResult
...
def test_actual_significance_engine_publishes_identical_complete_state(
    ...
    from relax.scoring.coarse_partition import CoarseRowGroup, CoarseRowPlan
    from relax.sparse_pass2 import sparse_pass2_scoring as sparse
