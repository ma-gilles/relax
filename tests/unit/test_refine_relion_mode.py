...
from relax.helpers.batch_fetch import fetch_indexed_batch as _fetch_indexed_batch
...
from relax.helpers.preprocessing import half_translation_phase_table, resolve_image_mask_for_half_preprocess
from relax.helpers.projection import compute_scale_correction_terms_per_image, relion_scale_correction_pixel_mask
...
from relax.local.local_em_engine import (
...
from relax.local.local_preprocessing import prepare_local_bucket
from relax.local.local_projection_cache import EXACT_LOCAL_RELION_PROJECTION_CACHE_MAX_GB_ENV
...
def test_project_local_bucket_accepts_singleton_class_relion_projector(monkeypatch):
    ...
    from relax.local import local_bucket_stages, local_em_engine
...
def test_local_big_jit_relion_projector_matches_helper(rng):
    from relax.helpers.projection import compute_relion_projector_projections_block
    from relax.local.local_big_jit import _project_local_half_spectrum
...
def test_local_relion_projection_cache_forwards_texture_selection(monkeypatch):
    from relax.local import local_projection_cache
...
def test_exact_local_progress_env_and_hook(monkeypatch):
    ...
    from relax.local import local_em_engine, local_timing
...
def test_run_local_em_exact_matches_dense_engine_on_single_image_local_grid(rng):
    ...
    from relax.helpers.adjoint import adjoint_slice_volume_maybe_windowed
...
def test_run_local_em_exact_windowed_relion_projector_big_jit_matches_split(monkeypatch, rng):
    import weakref
    from relax.local import local_em_engine as engine_module
...
def test_fused_score_normalize_mstep_matches_split_path():
    ...
    from relax.local.local_backprojection import compute_local_ctf_sums, compute_local_weighted_sums
    from relax.local.local_score_pass import (
        compute_reconstruction_support,
