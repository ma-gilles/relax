...
from relax.scoring.compact_candidates import SparseCandidateMask, _candidate_mask_count
...
from relax.sparse_pass2.sparse_pass2_wavg import _weighted_image_power_shells_and_per_image
...
def test_k1_pass2_dump_progress_requires_complete_target_set(tmp_path):
    from relax.diagnostics.sparse_pass2_dump import _k1_pass2_dump_progress
...
def test_sparse_pass2_rotation_chunking_matches_unchunked_windowed_path(
    ...
    from relax.diagnostics import bpref_diagnostics
    from relax.diagnostics import compact_candidate_capture as capture_mod
    from relax.sparse_pass2 import sparse_pass2_bucketed as bucketed_mod
...
def test_kclass_raw_bucket_bytes_include_every_padded_class(dtype):
    from relax.sparse_pass2.sparse_pass2_budget import _kclass_raw_diff2_bytes
...
def test_sparse_pass2_native_firstiter_preserves_prefix_and_normalizes_once(
    ...
    from relax.cuda import kernels as em_cuda_kernels
    from relax.sparse_pass2 import firstiter_bpref, sparse_pass2_policy, sparse_pass2_projection_blocks
    from relax.diagnostics import bpref_diagnostics
    from relax.relion import relion_ctf
    from relax.sparse_pass2 import (
