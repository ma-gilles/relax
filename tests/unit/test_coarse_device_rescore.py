...
from relax.scoring.coarse_device_selection import decode_device_coarse_selection
...
def host_oracle(operands, kwargs, actual, logical):
    ...
    from relax.scoring.coarse_gemm_hybrid import initialize_coarse_gemm_hybrid_interval_state
