...
def test_fullschedule_boundary_can_replay_the_same_native_worker_trace():
    ...
    required = [
        ...
        "export RELAX_RELION_VDAM_WORKER_SCHEDULE_NPZ=${CANDIDATE_WORKER_SCHEDULE}",
    ]
...
def test_fullschedule_boundary_seals_and_replays_each_native_block_chronology():
    ...
    required = [
        ...
        "export RELAX_RELION_VDAM_BLOCK_CHRONOLOGY_NPZ=${REPLAY_BLOCK_CHRONOLOGY}",
        "export RELAX_RELION_VDAM_WORKER_REPLAY_TOPOLOGY=${WORKER_REPLAY_TOPOLOGY}",
    ]
    for text in required:
        assert text in runner
...
def test_fullschedule_boundary_can_seal_passive_candidate_block_chronology():
    ...
    required = [
        ...
        "export RELAX_VDAM_CANDIDATE_BLOCK_TRACE=${CANDIDATE_BLOCK_TRACE}",
        "export RELAX_VDAM_CANDIDATE_BLOCK_TRACE_ITER=${TARGET_ITERATION}",
...
def test_fullschedule_boundary_seals_candidate_to_native_block_map():
    ...
    required = [
        ...
        "export RELAX_VDAM_CANDIDATE_BLOCK_MAP=${CANDIDATE_BLOCK_MAP}",
