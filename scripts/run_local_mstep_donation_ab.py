...
def _resolve_gf46_consumed_inputs(
    ...
    from relax.relion.vdam_checkpoint import (
...
def main(argv: list[str] | None = None) -> int:
    ...
    from relax.commands.initial_model import main as initial_model_command
