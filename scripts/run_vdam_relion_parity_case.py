...
def _recovar_native_extension_provenance(
    ...
    bind_matches = sorted((repo / "relax" / "relion_bind").glob("_relion_bind_core*.so"))
...
def run_case(args: argparse.Namespace) -> dict[str, Any]:
    ...
    image_batch_size = int(os.environ.get("RELAX_VDAM_IMAGE_BATCH_SIZE", "500"))
    ...
    provenance = {
        ...
        "recovar_sparse_big_jit_mstep_max_gb": os.environ.get(
            "RELAX_EXACT_LOCAL_SPARSE_BIG_JIT_MSTEP_MAX_GB"
        ),
    ...
    recorded_env_keys = (
        ...
        "RELAX_INITIAL_MODEL_UNIFY_LOCAL_BUCKET_SIZES",
        "RELAX_INITIAL_MODEL_PROJECTOR_DUMP_DIR",
        "RELAX_INITIALMODEL_NOISE_UPDATE_DUMP_DIR",
        "RELAX_INITIALMODEL_NOISE_UPDATE_DUMP_ITERATION",
        ...
        "RELAX_PASS2_DUMP_CURRENT_SIZE",
        "RELAX_PASS2_DUMP_ITERATION",
        "RELAX_PASS2_DUMP_RAW_OPERANDS",
        "RELAX_PASS2_DUMP_STOP_AFTER_TARGET",
        ...
        "RELAX_LOCAL_SCORE_DUMP_OPERANDS",
        "RELAX_LOCAL_NOISE_COMPONENT_DUMP_DIR",
