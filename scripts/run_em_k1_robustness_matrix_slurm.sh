...
if [[ -n "${RELAX_FINAL_ALL_DATA_GRID_CORRECT+set}" ]]; then
  # Retired: final all-data maps are always gridding-corrected, as in RELION.
  echo "RELAX_FINAL_ALL_DATA_GRID_CORRECT is retired; unset it" >&2
  exit 2
fi
