...
RELAX_RELION_EM_BATCH_PROJECTION_FRACTION="${RELAX_RELION_EM_BATCH_PROJECTION_FRACTION:-0.40}"
RELAX_RELION_FIRSTITER_RECON_COMPLEX_BUDGET="${RELAX_RELION_FIRSTITER_RECON_COMPLEX_BUDGET:-}"
RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE="${RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE:-}"
RELAX_FINAL_ALL_DATA_USE_MERGED_REFERENCE="${RELAX_FINAL_ALL_DATA_USE_MERGED_REFERENCE:-}"
RELAX_FINAL_ALL_DATA_DISABLE_REPLAY_LAST_NUMBERED_STATE="${RELAX_FINAL_ALL_DATA_DISABLE_REPLAY_LAST_NUMBERED_STATE:-}"
RELAX_FINAL_ALL_DATA_GRID_CORRECT="${RELAX_FINAL_ALL_DATA_GRID_CORRECT:-}"
RELAX_K1_RELION_EXACT_TRANSLATION_GRID="${RELAX_K1_RELION_EXACT_TRANSLATION_GRID:-}"
RELAX_K1_RELION_POWERCLASS_SPECTRUM_NORM="${RELAX_K1_RELION_POWERCLASS_SPECTRUM_NORM:-}"
RELAX_K1_RELION_EXACT_BPREF_OPERANDS="${RELAX_K1_RELION_EXACT_BPREF_OPERANDS:-}"
RELAX_K1_RELION_LIVE_INITIAL_NOISE="${RELAX_K1_RELION_LIVE_INITIAL_NOISE:-}"
RELAX_INITIAL_PROJECTOR_USE_REAL_REFERENCE="${RELAX_INITIAL_PROJECTOR_USE_REAL_REFERENCE:-}"
RELAX_FIRSTITER_CC_TREE_TOP2_RESCORE_MAX_MARGIN="${RELAX_FIRSTITER_CC_TREE_TOP2_RESCORE_MAX_MARGIN:-}"
RELAX_LOCAL_ADAPTIVE_PASS2_FULL_PARENT="${RELAX_LOCAL_ADAPTIVE_PASS2_FULL_PARENT:-0}"
RELAX_LOCAL_ADAPTIVE_PASS2_ROTATION_ONLY="${RELAX_LOCAL_ADAPTIVE_PASS2_ROTATION_ONLY:-}"
RELAX_LOCAL_ADAPTIVE_PASS2_DENOMINATOR_SUPPORT="${RELAX_LOCAL_ADAPTIVE_PASS2_DENOMINATOR_SUPPORT:-}"
RELAX_BPREF_ACCUM_DUMP_DIR="${RELAX_BPREF_ACCUM_DUMP_DIR:-}"
RELAX_BPREF_CONTRIBUTION_DUMP_DIR="${RELAX_BPREF_CONTRIBUTION_DUMP_DIR:-}"
RELAX_BPREF_CONTRIBUTION_DUMP_ITERATION="${RELAX_BPREF_CONTRIBUTION_DUMP_ITERATION:-}"
RELAX_BPREF_CONTRIBUTION_DUMP_HALF="${RELAX_BPREF_CONTRIBUTION_DUMP_HALF:-}"
RELAX_BPREF_CONTRIBUTION_DUMP_CURRENT_SIZE="${RELAX_BPREF_CONTRIBUTION_DUMP_CURRENT_SIZE:-}"
RELAX_BPREF_CONTRIBUTION_DUMP_ORIGINAL_INDICES="${RELAX_BPREF_CONTRIBUTION_DUMP_ORIGINAL_INDICES:-}"
RELAX_BPREF_CONTRIBUTION_DUMP_RUN_ID="${RELAX_BPREF_CONTRIBUTION_DUMP_RUN_ID:-}"
RELAX_BPREF_CONTRIBUTION_IMAGE_NAMES_NPY="${RELAX_BPREF_CONTRIBUTION_IMAGE_NAMES_NPY:-}"
RELAX_BPREF_CONTRIBUTION_STACK_SHA256="${RELAX_BPREF_CONTRIBUTION_STACK_SHA256:-}"
RELAX_PASS2_DUMP_DIR="${RELAX_PASS2_DUMP_DIR:-}"
RELAX_PASS2_DUMP_ORIGINAL_INDICES="${RELAX_PASS2_DUMP_ORIGINAL_INDICES:-}"
RELAX_PASS2_DUMP_CURRENT_SIZE="${RELAX_PASS2_DUMP_CURRENT_SIZE:-}"
RELAX_PASS2_DUMP_ITERATION="${RELAX_PASS2_DUMP_ITERATION:-}"
RELAX_SIGNIFICANCE_DUMP_DIR="${RELAX_SIGNIFICANCE_DUMP_DIR:-}"
RELAX_SIGNIFICANCE_DUMP_ORIGINAL_INDICES="${RELAX_SIGNIFICANCE_DUMP_ORIGINAL_INDICES:-}"
RELAX_SIGNIFICANCE_DUMP_CURRENT_SIZE="${RELAX_SIGNIFICANCE_DUMP_CURRENT_SIZE:-}"
RELAX_SIGNIFICANCE_DUMP_ITERATION="${RELAX_SIGNIFICANCE_DUMP_ITERATION:-}"
RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR="${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR:-}"
RELAX_LOCAL_FUSED_POSTERIOR_DUMP_GLOBAL_INDICES="${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_GLOBAL_INDICES:-}"
RELAX_LOCAL_FUSED_POSTERIOR_DUMP_CURRENT_SIZE="${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_CURRENT_SIZE:-}"
RELAX_LOCAL_FUSED_POSTERIOR_DUMP_ITERATION="${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_ITERATION:-}"
RELAX_LOCAL_FUSED_POSTERIOR_DUMP_LABEL="${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_LABEL:-}"
RELAX_LOCAL_SCORE_DUMP_DIR="${RELAX_LOCAL_SCORE_DUMP_DIR:-}"
RELAX_LOCAL_SCORE_DUMP_GLOBAL_INDICES="${RELAX_LOCAL_SCORE_DUMP_GLOBAL_INDICES:-}"
RELAX_LOCAL_SCORE_DUMP_CURRENT_SIZE="${RELAX_LOCAL_SCORE_DUMP_CURRENT_SIZE:-}"
RELAX_LOCAL_SCORE_DUMP_ITERATION="${RELAX_LOCAL_SCORE_DUMP_ITERATION:-}"
RELAX_LOCAL_SCORE_DUMP_LABEL="${RELAX_LOCAL_SCORE_DUMP_LABEL:-}"
RELAX_LOCAL_SCORE_DUMP_OPERANDS="${RELAX_LOCAL_SCORE_DUMP_OPERANDS:-}"
RELAX_EXACT_LOCAL_TARGET_ROW_PIXELS="${RELAX_EXACT_LOCAL_TARGET_ROW_PIXELS:-}"
RELAX_EXACT_LOCAL_BIG_JIT_MATMUL_MAX_GB="${RELAX_EXACT_LOCAL_BIG_JIT_MATMUL_MAX_GB:-}"
RELAX_EXACT_LOCAL_AUTO_MICROBATCH_BOOST="${RELAX_EXACT_LOCAL_AUTO_MICROBATCH_BOOST:-}"
RELAX_EXACT_LOCAL_PACKED_NOISE_TARGET_ROW_PIXELS="${RELAX_EXACT_LOCAL_PACKED_NOISE_TARGET_ROW_PIXELS:-}"
RELAX_EXACT_LOCAL_XHALF_PROJECTION_TARGET_ROW_PIXELS="${RELAX_EXACT_LOCAL_XHALF_PROJECTION_TARGET_ROW_PIXELS:-}"
RELAX_EXACT_LOCAL_PROGRESS_CHUNKS="${RELAX_EXACT_LOCAL_PROGRESS_CHUNKS:-}"
RELAX_EXACT_LOCAL_PROGRESS_SECONDS="${RELAX_EXACT_LOCAL_PROGRESS_SECONDS:-}"
RELAX_RELION_PROJECTOR_DUMP_DIR="${RELAX_RELION_PROJECTOR_DUMP_DIR:-}"
RELAX_MSTEP_DUMP_DIR="${RELAX_MSTEP_DUMP_DIR:-}"
RELAX_MSTEP_DUMP_MAX_CALLS="${RELAX_MSTEP_DUMP_MAX_CALLS:-}"
RELAX_MSTEP_DUMP_RAW="${RELAX_MSTEP_DUMP_RAW:-}"
RELAX_SAVE_INTERMEDIATES_DIR="${RELAX_SAVE_INTERMEDIATES_DIR:-}"
RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED="${RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED:-1}"
RELAX_RELION_CURRENT_SIZES="${RELAX_RELION_CURRENT_SIZES:-}"
...
Environment overrides:
  ...
  RELAX_LOCAL_BUCKET_QUANTUM      Override large-support bucket quantum for sparse pass-2 tails
  ...
  RELAX_K1_RELION_EXACT_TRANSLATION_GRID
  ...
  RELAX_K1_RELION_LIVE_INITIAL_NOISE
  ...
  RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE
                                    ...
                                    (current: ${RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE:-mode default}).
  RELAX_FINAL_ALL_DATA_USE_MERGED_REFERENCE
                                    Diagnostic only: use merged K=1 reference for final all-data scoring (default: ${RELAX_FINAL_ALL_DATA_USE_MERGED_REFERENCE:-<unset>})
  RELAX_FINAL_ALL_DATA_DISABLE_REPLAY_LAST_NUMBERED_STATE
                                    Diagnostic only: disable automatic final last-numbered RELION replay (default: ${RELAX_FINAL_ALL_DATA_DISABLE_REPLAY_LAST_NUMBERED_STATE:-<unset>})
  ...
  RELAX_LOCAL_ADAPTIVE_PASS2_FULL_PARENT
                                    Diagnostic full-parent expansion for adaptive local pass-2; default 0 matches RELION's pruned parent support (current: ${RELAX_LOCAL_ADAPTIVE_PASS2_FULL_PARENT})
  RELAX_LOCAL_ADAPTIVE_PASS2_ROTATION_ONLY
                                    Diagnostic only: keep pass-1 significant parent rotations but expand all parent translations.
  RELAX_LOCAL_ADAPTIVE_PASS2_DENOMINATOR_SUPPORT
  ...
  RELAX_BPREF_ACCUM_DUMP_DIR      Diagnostic only: base directory for per-case RECOVAR per-iteration
                                    BPref accumulator dumps (default: ${RELAX_BPREF_ACCUM_DUMP_DIR:-<unset>})
  ...
  RELAX_PASS2_DUMP_DIR            Diagnostic only: base directory for per-case RECOVAR pass-2 operand dumps
                                    (default: ${RELAX_PASS2_DUMP_DIR:-<unset>})
  RELAX_PASS2_DUMP_ORIGINAL_INDICES
                                    Comma-separated original particle indices for RELAX_PASS2_DUMP_DIR
                                    (default: ${RELAX_PASS2_DUMP_ORIGINAL_INDICES:-<unset>})
  RELAX_PASS2_DUMP_CURRENT_SIZE   Current size filter for RELAX_PASS2_DUMP_DIR
                                    (default: ${RELAX_PASS2_DUMP_CURRENT_SIZE:-<unset>})
  RELAX_PASS2_DUMP_ITERATION      Numbered-iteration filter for RELAX_PASS2_DUMP_DIR
                                    (default: ${RELAX_PASS2_DUMP_ITERATION:-<unset>})
  RELAX_SIGNIFICANCE_DUMP_DIR     Diagnostic only: base directory for per-case RECOVAR pass-1
                                    significance/posterior dumps
                                    (default: ${RELAX_SIGNIFICANCE_DUMP_DIR:-<unset>})
  RELAX_SIGNIFICANCE_DUMP_ORIGINAL_INDICES
                                    Comma-separated original particle indices for significance dumps
                                    (default: ${RELAX_SIGNIFICANCE_DUMP_ORIGINAL_INDICES:-<unset>})
  RELAX_SIGNIFICANCE_DUMP_CURRENT_SIZE
                                    Current size filter for significance dumps
                                    (default: ${RELAX_SIGNIFICANCE_DUMP_CURRENT_SIZE:-<unset>})
  RELAX_SIGNIFICANCE_DUMP_ITERATION
                                    One-based iteration filter for significance dumps
                                    (default: ${RELAX_SIGNIFICANCE_DUMP_ITERATION:-<unset>})
  RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR
                                    Diagnostic only: base directory for per-case production fused-path
                                    local posterior dumps (default: ${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR:-<unset>})
  RELAX_LOCAL_FUSED_POSTERIOR_DUMP_GLOBAL_INDICES
                                    Comma-separated original particle indices for fused-path posterior dumps
                                    (default: ${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_GLOBAL_INDICES:-<unset>})
  RELAX_LOCAL_FUSED_POSTERIOR_DUMP_CURRENT_SIZE
                                    Current size filter for fused-path posterior dumps
                                    (default: ${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_CURRENT_SIZE:-<unset>})
  RELAX_LOCAL_FUSED_POSTERIOR_DUMP_ITERATION
                                    Iteration filter for fused-path posterior dumps
                                    (default: ${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_ITERATION:-<unset>})
  RELAX_LOCAL_FUSED_POSTERIOR_DUMP_LABEL
                                    Optional filename label for fused-path posterior dumps
                                    (default: ${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_LABEL:-<unset>})
  RELAX_LOCAL_SCORE_DUMP_DIR      Diagnostic only: base directory for materialized local score dumps.
                                    This forces the non-fused local path for targeted particles
                                    (default: ${RELAX_LOCAL_SCORE_DUMP_DIR:-<unset>})
  RELAX_LOCAL_SCORE_DUMP_GLOBAL_INDICES
                                    Comma-separated original particle indices for local score dumps
                                    (default: ${RELAX_LOCAL_SCORE_DUMP_GLOBAL_INDICES:-<unset>})
  RELAX_LOCAL_SCORE_DUMP_CURRENT_SIZE
                                    Current size filter for local score dumps; use -1 for final full-size
                                    current_size=None (default: ${RELAX_LOCAL_SCORE_DUMP_CURRENT_SIZE:-<unset>})
  RELAX_LOCAL_SCORE_DUMP_ITERATION
                                    Iteration filter for local score dumps (default: ${RELAX_LOCAL_SCORE_DUMP_ITERATION:-<unset>})
  RELAX_LOCAL_SCORE_DUMP_LABEL    Optional filename label for local score dumps
                                    (default: ${RELAX_LOCAL_SCORE_DUMP_LABEL:-<unset>})
  RELAX_LOCAL_SCORE_DUMP_OPERANDS Set 1 to include large score/reconstruction operands in local score dumps
                                    (default: ${RELAX_LOCAL_SCORE_DUMP_OPERANDS:-<unset>})
  RELAX_EXACT_LOCAL_TARGET_ROW_PIXELS
                                    Exact-local bucket row-pixel cap for speed probes.
  RELAX_EXACT_LOCAL_BIG_JIT_MATMUL_MAX_GB
                                    Exact-local M-step row-output cap in GB for speed probes.
  RELAX_EXACT_LOCAL_AUTO_MICROBATCH_BOOST
                                    Multiplier for exact-local automatic microbatch boosting when
                                    row caps are not explicitly overridden.
  RELAX_EXACT_LOCAL_PACKED_NOISE_TARGET_ROW_PIXELS
                                    Memory guard for exact local packed-noise projection rows.
                                    Lower this for OOM retries (default: RECOVAR internal default).
  RELAX_EXACT_LOCAL_XHALF_PROJECTION_TARGET_ROW_PIXELS
                                    Memory guard for fused exact-local x-half projection rows.
                                    Lower this for OOM diagnostics (default: RECOVAR internal default).
  RELAX_EXACT_LOCAL_PROGRESS_CHUNKS
                                    Exact-local bucket progress interval in completed chunks.
  RELAX_EXACT_LOCAL_PROGRESS_SECONDS
                                    Exact-local bucket progress interval in seconds.
  RELAX_RELION_PROJECTOR_DUMP_DIR Diagnostic only: base directory for per-case RELION Projector::data
                                    slabs built by RECOVAR for scoring (default: ${RELAX_RELION_PROJECTOR_DUMP_DIR:-<unset>})
  RELAX_MSTEP_DUMP_DIR            Diagnostic only: base directory for per-case RELION BPref/updateSSNR dumps
                                    from the patched RELION build (default: ${RELAX_MSTEP_DUMP_DIR:-<unset>})
  RELAX_MSTEP_DUMP_MAX_CALLS      Max RELION BPref dump calls per process (default: RELION patch default)
  RELAX_MSTEP_DUMP_RAW            Set 1 to include raw RELION BPref data/weight binary dumps
  RELAX_SAVE_INTERMEDIATES_DIR    Diagnostic only: pass --save_intermediates_dir to RECOVAR.
                                    Set to auto/1 for <recovar>/intermediates or to a base path for
                                    per-case subdirectories (default: ${RELAX_SAVE_INTERMEDIATES_DIR:-<unset>})
  RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED
                                    When intermediates are enabled, skip diagnostic unregularized
                                    maps by default to keep FSC debugging fast. Set to 0 to save
                                    the unregularized maps too (default: ${RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED})
  RELAX_RELION_CURRENT_SIZES      Diagnostic only: comma-separated per-iteration current-size
...
case "${SCORECARD_MODE}" in
  ...
  1)
    ...
    RELAX_SAVE_INTERMEDIATES_DIR=1
    RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED=1
    ;;
  *)
...
if [[ "${SCORECARD_MODE}" == "1" ]]; then
  ...
  if [[ "${RELAX_FINAL_ALL_DATA_GRID_CORRECT}" =~ ^(1|true|TRUE|yes|YES|on|ON)$ ]]; then
    echo "--scorecard requires RELAX_FINAL_ALL_DATA_GRID_CORRECT unset/off" >&2
    exit 2
  fi
  if [[ "${RELAX_K1_RELION_EXACT_TRANSLATION_GRID}" =~ ^(0|false|FALSE|no|NO|off|OFF)$ ]]; then
    echo "--scorecard requires RELAX_K1_RELION_EXACT_TRANSLATION_GRID unset/on" >&2
    exit 2
  fi
  if [[ "${RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE}" =~ ^(1|true|TRUE|yes|YES|on|ON)$ ]]; then
    echo "--scorecard requires RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE=0" >&2
    exit 2
  fi
  if [[ "${RELAX_LOCAL_ADAPTIVE_PASS2_FULL_PARENT}" =~ ^(1|true|TRUE|yes|YES|on|ON)$ ]]; then
    echo "--scorecard requires RELAX_LOCAL_ADAPTIVE_PASS2_FULL_PARENT=0" >&2
    exit 2
  fi
  RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE=0
  RELAX_LOCAL_ADAPTIVE_PASS2_FULL_PARENT=0
fi
if [[ -z "${RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE}" ]]; then
  if [[ "${TRAJECTORY_MODE}" == "controlled" ]]; then
    RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE=1
  else
    RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE=0
  fi
fi
...
unset RELAX_FINAL_ALL_DATA_AFTER_MAX_ITER RELAX_DISABLE_RELION_EXACT_FINE_GAUSSIAN
unset RELAX_RELION_FINE_DIFF2_FUSED_FFI
unset RELAX_USE_FLOAT64_SCORING RELAX_USE_FLOAT64_PROJECTIONS
...
$(write_optional_env_exports TF_GPU_ALLOCATOR RELAX_RELION_EM_BATCH_PROJECTION_FRACTION RELAX_RELION_FIRSTITER_RECON_COMPLEX_BUDGET RELAX_PASS1_FUSED RELAX_DISABLE_LOCAL_BIG_JIT RELAX_LOCAL_BUCKET_QUANTUM RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MAX_IMAGES RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MAX_INFLATION RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MIN_BUCKET_SIZE RELAX_SPARSE_PASS2_MAX_TRANSLATION_TILE_BYTES RELAX_SPARSE_PASS2_MAX_PROJECTION_GATHER_BYTES RELAX_SPARSE_PASS2_MAX_NOISE_BLOCK_BYTES RELAX_SPARSE_PASS2_MAX_ADJOINT_BLOCK_BYTES RELAX_SPARSE_PASS2_PROJECTION_CACHE_MAX_BYTES RELAX_SPARSE_PASS2_MAX_PROJECTED_ROTATIONS RELAX_K1_DENSE_PASS2 RELAX_K1_SKIP_SIGNIFICANCE_PRUNING RECOVAR_K1_COARSE_GAUSSIAN_FFI RELAX_K1_RELION_EXACT_TRANSLATION_GRID RELAX_K1_RELION_POWERCLASS_SPECTRUM_NORM RELAX_K1_RELION_EXACT_BPREF_OPERANDS RELAX_K1_RELION_LIVE_INITIAL_NOISE RELAX_K1_RELION_X_HALF_MSTEP RELAX_RELION_X_HALF_MSTEP_DOUBLE RELAX_RELION_FINE_DIFF2_FUSED_FFI RELAX_EM_LOW_PMAX_REFINE_GUARD RELAX_EM_LOW_PMAX_REFINE_MAX_AVE_PMAX RELAX_EM_LOW_PMAX_REFINE_REQUIRE_LOCAL RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE RELAX_FINAL_ALL_DATA_USE_MERGED_REFERENCE RELAX_FINAL_ALL_DATA_DISABLE_REPLAY_LAST_NUMBERED_STATE RELAX_FINAL_ALL_DATA_GRID_CORRECT RELAX_INITIAL_PROJECTOR_USE_REAL_REFERENCE RELAX_FIRSTITER_CC_TREE_TOP2_RESCORE_MAX_MARGIN RELAX_LOCAL_ADAPTIVE_PASS2_FULL_PARENT RELAX_LOCAL_ADAPTIVE_PASS2_ROTATION_ONLY RELAX_LOCAL_ADAPTIVE_PASS2_DENOMINATOR_SUPPORT RELAX_BPREF_ACCUM_DUMP_DIR RELAX_PASS2_DUMP_DIR RELAX_PASS2_DUMP_ORIGINAL_INDICES RELAX_PASS2_DUMP_CURRENT_SIZE RELAX_PASS2_DUMP_ITERATION RELAX_SIGNIFICANCE_DUMP_DIR RELAX_SIGNIFICANCE_DUMP_ORIGINAL_INDICES RELAX_SIGNIFICANCE_DUMP_CURRENT_SIZE RELAX_SIGNIFICANCE_DUMP_ITERATION RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR RELAX_LOCAL_FUSED_POSTERIOR_DUMP_GLOBAL_INDICES RELAX_LOCAL_FUSED_POSTERIOR_DUMP_CURRENT_SIZE RELAX_LOCAL_FUSED_POSTERIOR_DUMP_ITERATION RELAX_LOCAL_FUSED_POSTERIOR_DUMP_LABEL RELAX_LOCAL_SCORE_DUMP_DIR RELAX_LOCAL_SCORE_DUMP_GLOBAL_INDICES RELAX_LOCAL_SCORE_DUMP_CURRENT_SIZE RELAX_LOCAL_SCORE_DUMP_ITERATION RELAX_LOCAL_SCORE_DUMP_LABEL RELAX_LOCAL_SCORE_DUMP_OPERANDS RELAX_EXACT_LOCAL_AUTO_MICROBATCH_BOOST RELAX_EXACT_LOCAL_PACKED_NOISE_TARGET_ROW_PIXELS RELAX_EXACT_LOCAL_PROGRESS_CHUNKS RELAX_EXACT_LOCAL_PROGRESS_SECONDS RELAX_RELION_PROJECTOR_DUMP_DIR RELAX_MSTEP_DUMP_DIR RELAX_MSTEP_DUMP_MAX_CALLS RELAX_MSTEP_DUMP_RAW RELAX_SAVE_INTERMEDIATES_DIR RELAX_RELION_CURRENT_SIZES RELION_DUMP_DIR RELION_DUMP_STACK_INDEX RELION_DUMP_PART_ID RELION_DUMP_PART RELION_DUMP_ITER)
$(write_optional_env_exports RECOVAR_K1_COARSE_GAUSSIAN_NATIVE_TEXTURE RELAX_K1_BPREF_EXECUTION_ORDER_CHUNK_SIZE)
$(write_optional_env_exports RELION_ACC_DUMP_VERBOSE RELION_ACC_DUMP_PASS1_DIFF2)
export RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED="${RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED}"
echo "RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED=${RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED}"
$(write_optional_env_exports RELAX_EXACT_LOCAL_TARGET_ROW_PIXELS RELAX_EXACT_LOCAL_BIG_JIT_MATMUL_MAX_GB RELAX_BPREF_CONTRIBUTION_DUMP_DIR RELAX_BPREF_CONTRIBUTION_DUMP_ITERATION RELAX_BPREF_CONTRIBUTION_DUMP_HALF RELAX_BPREF_CONTRIBUTION_DUMP_CURRENT_SIZE RELAX_BPREF_CONTRIBUTION_DUMP_ORIGINAL_INDICES RELAX_BPREF_CONTRIBUTION_DUMP_RUN_ID RELAX_BPREF_CONTRIBUTION_IMAGE_NAMES_NPY RELAX_BPREF_CONTRIBUTION_STACK_SHA256)
$(write_optional_env_exports RELAX_EXACT_LOCAL_XHALF_PROJECTION_TARGET_ROW_PIXELS)
if [[ -n "\${RELAX_EXACT_LOCAL_XHALF_PROJECTION_TARGET_ROW_PIXELS:-}" ]]; then
  echo "RELAX_EXACT_LOCAL_XHALF_PROJECTION_TARGET_ROW_PIXELS=\${RELAX_EXACT_LOCAL_XHALF_PROJECTION_TARGET_ROW_PIXELS}"
fi
for env_name in TF_GPU_ALLOCATOR RELAX_RELION_EM_BATCH_PROJECTION_FRACTION RELAX_RELION_FIRSTITER_RECON_COMPLEX_BUDGET RELAX_PASS1_FUSED RELAX_DISABLE_LOCAL_BIG_JIT RELAX_LOCAL_BUCKET_QUANTUM RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MAX_IMAGES RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MAX_INFLATION RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MIN_BUCKET_SIZE RELAX_SPARSE_PASS2_MAX_TRANSLATION_TILE_BYTES RELAX_SPARSE_PASS2_MAX_PROJECTION_GATHER_BYTES RELAX_SPARSE_PASS2_MAX_NOISE_BLOCK_BYTES RELAX_SPARSE_PASS2_MAX_ADJOINT_BLOCK_BYTES RELAX_SPARSE_PASS2_PROJECTION_CACHE_MAX_BYTES RELAX_SPARSE_PASS2_MAX_PROJECTED_ROTATIONS RELAX_K1_DENSE_PASS2 RELAX_K1_SKIP_SIGNIFICANCE_PRUNING RECOVAR_K1_COARSE_GAUSSIAN_FFI RELAX_K1_RELION_EXACT_TRANSLATION_GRID RELAX_K1_RELION_POWERCLASS_SPECTRUM_NORM RELAX_K1_RELION_EXACT_BPREF_OPERANDS RELAX_K1_RELION_LIVE_INITIAL_NOISE RELAX_K1_RELION_X_HALF_MSTEP RELAX_RELION_X_HALF_MSTEP_DOUBLE RELAX_RELION_FINE_DIFF2_FUSED_FFI RELAX_EM_LOW_PMAX_REFINE_GUARD RELAX_EM_LOW_PMAX_REFINE_MAX_AVE_PMAX RELAX_EM_LOW_PMAX_REFINE_MIN_RES_STALL RELAX_EM_LOW_PMAX_REFINE_REQUIRE_LOCAL RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE RELAX_FINAL_ALL_DATA_USE_MERGED_REFERENCE RELAX_FINAL_ALL_DATA_DISABLE_REPLAY_LAST_NUMBERED_STATE RELAX_FINAL_ALL_DATA_GRID_CORRECT RELAX_INITIAL_PROJECTOR_USE_REAL_REFERENCE RELAX_FIRSTITER_CC_TREE_TOP2_RESCORE_MAX_MARGIN RELAX_LOCAL_ADAPTIVE_PASS2_FULL_PARENT RELAX_LOCAL_ADAPTIVE_PASS2_ROTATION_ONLY RELAX_LOCAL_ADAPTIVE_PASS2_DENOMINATOR_SUPPORT RELAX_BPREF_ACCUM_DUMP_DIR RELAX_PASS2_DUMP_DIR RELAX_PASS2_DUMP_ORIGINAL_INDICES RELAX_PASS2_DUMP_CURRENT_SIZE RELAX_PASS2_DUMP_ITERATION RELAX_SIGNIFICANCE_DUMP_DIR RELAX_SIGNIFICANCE_DUMP_ORIGINAL_INDICES RELAX_SIGNIFICANCE_DUMP_CURRENT_SIZE RELAX_SIGNIFICANCE_DUMP_ITERATION RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR RELAX_LOCAL_FUSED_POSTERIOR_DUMP_GLOBAL_INDICES RELAX_LOCAL_FUSED_POSTERIOR_DUMP_CURRENT_SIZE RELAX_LOCAL_FUSED_POSTERIOR_DUMP_ITERATION RELAX_LOCAL_FUSED_POSTERIOR_DUMP_LABEL RELAX_LOCAL_SCORE_DUMP_DIR RELAX_LOCAL_SCORE_DUMP_GLOBAL_INDICES RELAX_LOCAL_SCORE_DUMP_CURRENT_SIZE RELAX_LOCAL_SCORE_DUMP_ITERATION RELAX_LOCAL_SCORE_DUMP_LABEL RELAX_LOCAL_SCORE_DUMP_OPERANDS RELAX_EXACT_LOCAL_AUTO_MICROBATCH_BOOST RELAX_EXACT_LOCAL_PACKED_NOISE_TARGET_ROW_PIXELS RELAX_EXACT_LOCAL_PROGRESS_CHUNKS RELAX_EXACT_LOCAL_PROGRESS_SECONDS RELAX_RELION_PROJECTOR_DUMP_DIR RELAX_MSTEP_DUMP_DIR RELAX_MSTEP_DUMP_MAX_CALLS RELAX_MSTEP_DUMP_RAW RELAX_SAVE_INTERMEDIATES_DIR RELAX_RELION_CURRENT_SIZES RELION_DUMP_DIR RELION_DUMP_STACK_INDEX RELION_DUMP_PART_ID RELION_DUMP_PART RELION_DUMP_ITER; do
  env_value="\${!env_name-}"
  if [[ -n "\${env_value}" ]]; then
    echo "\${env_name}=\${env_value}"
  fi
done
for env_name in RECOVAR_K1_COARSE_GAUSSIAN_NATIVE_TEXTURE RELAX_K1_BPREF_EXECUTION_ORDER_CHUNK_SIZE; do
  env_value="\${!env_name-}"
  if [[ -n "\${env_value}" ]]; then
    echo "\${env_name}=\${env_value}"
  fi
...
for env_name in RELAX_EXACT_LOCAL_TARGET_ROW_PIXELS RELAX_EXACT_LOCAL_BIG_JIT_MATMUL_MAX_GB RELAX_BPREF_CONTRIBUTION_DUMP_DIR RELAX_BPREF_CONTRIBUTION_DUMP_ITERATION RELAX_BPREF_CONTRIBUTION_DUMP_HALF RELAX_BPREF_CONTRIBUTION_DUMP_CURRENT_SIZE RELAX_BPREF_CONTRIBUTION_DUMP_ORIGINAL_INDICES RELAX_BPREF_CONTRIBUTION_DUMP_RUN_ID RELAX_BPREF_CONTRIBUTION_IMAGE_NAMES_NPY RELAX_BPREF_CONTRIBUTION_STACK_SHA256; do
  env_value="\${!env_name-}"
  if [[ -n "\${env_value}" ]]; then
    echo "\${env_name}=\${env_value}"
  fi
...
CUDA_LIB_TMP="\${RELAX_CUDA_LIB}.\${SLURM_JOB_ID:-\$\$}.tmp"
export CUDA_LIB_TMP PIXI_PY
flock "${SCRATCH_DIR}/cuda/build.lock" bash -lc '
  set -euo pipefail
  if [[ -s "\${RELAX_CUDA_LIB}" ]]; then
    echo "Reusing shared CUDA library \${RELAX_CUDA_LIB}"
    exit 0
  fi
  rm -f "\${CUDA_LIB_TMP}"
  env PYTHON="\${PIXI_PY}" make -C relax/cuda LIB="\${CUDA_LIB_TMP}" all
  mv -f "\${CUDA_LIB_TMP}" "\${RELAX_CUDA_LIB}"
'
EOF
}
...
"\${EM_K1_MATRIX_BASE_PIXI_PY}" -m venv --system-site-packages --without-pip "\${EM_K1_MATRIX_VENV}"
...
RELAX_RELION_REPLAY_ARGS=(
  --relion_half_sets "${RELION_HALF_SET_STAR}"
  --relion_optimiser "${RELION_OPTIMISER_STAR}"
  --relion_init_dir "${RELION_DIR}"
)
echo "RECOVAR autonomous iter-0 args: ${RELAX_RELION_REPLAY_ARGS[*]}"
EOF
    return
  fi

  cat <<'EOF'
RELION_ITER_PADDED="$(printf "%03d" "${RELAX_MAX_ITER}")"
...
if [[ -n "${LATEST_RELION_SAMPLING_ITER}" ]]; then
  ...
  if [[ "${LATEST_RELION_SAMPLING_ITER}" -gt 0 && "${LATEST_RELION_SAMPLING_ITER}" -lt "${RELAX_MAX_ITER}" ]]; then
    echo "Strict RELION replay: capping RECOVAR max_iter ${RELAX_MAX_ITER} -> ${LATEST_RELION_SAMPLING_ITER} (last sampling.star)"
    RELAX_MAX_ITER="${LATEST_RELION_SAMPLING_ITER}"
  fi
fi
echo "RECOVAR strict RELION replay args: ${RELAX_RELION_REPLAY_ARGS[*]}"
EOF
}
...
CASE_ROOT="${case_root}"
DATA_DIR="${data_dir}"
RELAX_DIR="${recovar_dir}"
RELION_DIR="${relion_dir}"
mkdir -p "\${CASE_ROOT}" "\${DATA_DIR}" "\${RELAX_DIR}" "\${RELION_DIR}"
...
if [[ -n "\${RELAX_BPREF_ACCUM_DUMP_DIR:-}" ]]; then
  export RELAX_BPREF_ACCUM_DUMP_DIR="\${RELAX_BPREF_ACCUM_DUMP_DIR%/}/${idx}_${name}"
  mkdir -p "\${RELAX_BPREF_ACCUM_DUMP_DIR}"
  echo "RELAX_BPREF_ACCUM_DUMP_DIR=\${RELAX_BPREF_ACCUM_DUMP_DIR}"
fi
if [[ -n "\${RELAX_BPREF_CONTRIBUTION_DUMP_DIR:-}" ]]; then
  export RELAX_BPREF_CONTRIBUTION_DUMP_DIR="\${RELAX_BPREF_CONTRIBUTION_DUMP_DIR%/}/${idx}_${name}"
  mkdir -p "\${RELAX_BPREF_CONTRIBUTION_DUMP_DIR}"
  echo "RELAX_BPREF_CONTRIBUTION_DUMP_DIR=\${RELAX_BPREF_CONTRIBUTION_DUMP_DIR}"
fi
if [[ -n "\${RELAX_PASS2_DUMP_DIR:-}" ]]; then
  export RELAX_PASS2_DUMP_DIR="\${RELAX_PASS2_DUMP_DIR%/}/${idx}_${name}"
  mkdir -p "\${RELAX_PASS2_DUMP_DIR}"
  echo "RELAX_PASS2_DUMP_DIR=\${RELAX_PASS2_DUMP_DIR}"
fi
if [[ -n "\${RELAX_SIGNIFICANCE_DUMP_DIR:-}" ]]; then
  export RELAX_SIGNIFICANCE_DUMP_DIR="\${RELAX_SIGNIFICANCE_DUMP_DIR%/}/${idx}_${name}"
  mkdir -p "\${RELAX_SIGNIFICANCE_DUMP_DIR}"
  echo "RELAX_SIGNIFICANCE_DUMP_DIR=\${RELAX_SIGNIFICANCE_DUMP_DIR}"
fi
if [[ -n "\${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR:-}" ]]; then
  export RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR="\${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR%/}/${idx}_${name}"
  mkdir -p "\${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR}"
  echo "RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR=\${RELAX_LOCAL_FUSED_POSTERIOR_DUMP_DIR}"
fi
if [[ -n "\${RELAX_LOCAL_SCORE_DUMP_DIR:-}" ]]; then
  export RELAX_LOCAL_SCORE_DUMP_DIR="\${RELAX_LOCAL_SCORE_DUMP_DIR%/}/${idx}_${name}"
  mkdir -p "\${RELAX_LOCAL_SCORE_DUMP_DIR}"
  echo "RELAX_LOCAL_SCORE_DUMP_DIR=\${RELAX_LOCAL_SCORE_DUMP_DIR}"
fi
if [[ -n "\${RELAX_RELION_PROJECTOR_DUMP_DIR:-}" ]]; then
  export RELAX_RELION_PROJECTOR_DUMP_DIR="\${RELAX_RELION_PROJECTOR_DUMP_DIR%/}/${idx}_${name}"
  mkdir -p "\${RELAX_RELION_PROJECTOR_DUMP_DIR}"
  echo "RELAX_RELION_PROJECTOR_DUMP_DIR=\${RELAX_RELION_PROJECTOR_DUMP_DIR}"
fi
if [[ -n "\${RELAX_MSTEP_DUMP_DIR:-}" ]]; then
  export RELAX_MSTEP_DUMP_DIR="\${RELAX_MSTEP_DUMP_DIR%/}/${idx}_${name}"
  mkdir -p "\${RELAX_MSTEP_DUMP_DIR}"
  echo "RELAX_MSTEP_DUMP_DIR=\${RELAX_MSTEP_DUMP_DIR}"
fi
...
RELAX_EXTRA_ARGS=()
if [[ -n "\${RELAX_RELION_CURRENT_SIZES:-}" ]]; then
  RELAX_EXTRA_ARGS+=(--relion_current_sizes "\${RELAX_RELION_CURRENT_SIZES}")
fi
if [[ -n "\${RELAX_SAVE_INTERMEDIATES_DIR:-}" ]]; then
  if [[ "\${RELAX_SAVE_INTERMEDIATES_DIR}" == "1" || "\${RELAX_SAVE_INTERMEDIATES_DIR}" == "auto" ]]; then
    RELAX_INTERMEDIATES_DIR="\${RELAX_DIR}/intermediates"
  else
    RELAX_INTERMEDIATES_DIR="\${RELAX_SAVE_INTERMEDIATES_DIR%/}/${idx}_${name}"
  fi
  mkdir -p "\${RELAX_INTERMEDIATES_DIR}"
  echo "RELAX_INTERMEDIATES_DIR=\${RELAX_INTERMEDIATES_DIR}"
  RELAX_EXTRA_ARGS+=(--save_intermediates_dir "\${RELAX_INTERMEDIATES_DIR}")
  if [[ "\${RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED:-}" =~ ^(1|true|TRUE|yes|YES|on|ON)$ ]]; then
    RELAX_EXTRA_ARGS+=(--save_intermediates_skip_unregularized)
  fi
fi
...
if [[ -n "\${RELAX_BPREF_CONTRIBUTION_DUMP_DIR:-}" ]]; then
  if [[ -z "\${RELAX_BPREF_CONTRIBUTION_IMAGE_NAMES_NPY:-}" || -z "\${RELAX_BPREF_CONTRIBUTION_STACK_SHA256:-}" ]]; then
    ...
    export RELAX_BPREF_CONTRIBUTION_IMAGE_NAMES_NPY="\${BPREF_METADATA_DIR}/image_names.npy"
    export RELAX_BPREF_CONTRIBUTION_STACK_SHA256="\$("\${PIXI_PY}" -c 'import json,sys; print(json.load(open(sys.argv[1]))["source_stack_sha256"])' "\${BPREF_METADATA_MANIFEST}")"
  fi
  echo "RELAX_BPREF_CONTRIBUTION_IMAGE_NAMES_NPY=\${RELAX_BPREF_CONTRIBUTION_IMAGE_NAMES_NPY}"
  echo "RELAX_BPREF_CONTRIBUTION_STACK_SHA256=\${RELAX_BPREF_CONTRIBUTION_STACK_SHA256}"
fi
...
RELAX_RELION_REPLAY_ARGS=()
RELAX_MAX_ITER="${MAX_ITER}"
$(write_recovar_trajectory_setup)
RELAX_GPU_UUID="\$(capture_physical_gpu_uuid)"
if [[ "\${RELAX_GPU_UUID}" != "\${CASE_GPU_UUID}" || ( -n "\${RELION_GPU_UUID}" && "\${RELAX_GPU_UUID}" != "\${RELION_GPU_UUID}" ) ]]; then
  echo "ERROR: RECOVAR and RELION did not use the same physical GPU: RELION=\${RELION_GPU_UUID:-<not-run>} RECOVAR=\${RELAX_GPU_UUID}" >&2
  exit 2
fi
printf '%s\n' "\${RELAX_GPU_UUID}" > "\${RELAX_DIR}/physical_gpu_uuid.txt"
cat > "\${CASE_ROOT}/paired_gpu_uuid.json" <<JSON
{"physical_gpu_uuid":"\${CASE_GPU_UUID}","relion_gpu_uuid":"\${RELION_GPU_UUID}","recovar_gpu_uuid":"\${RELAX_GPU_UUID}"}
JSON
START_EPOCH="\$(date +%s)"
set +e
...
if [[ "\${RELAX_POST_GPU_UUID}" != "\${CASE_GPU_UUID}" || ( -n "\${RELION_GPU_UUID}" && "\${RELAX_POST_GPU_UUID}" != "\${RELION_GPU_UUID}" ) ]]; then
  echo "ERROR: RECOVAR physical GPU changed during its run: expected \${RELION_GPU_UUID:-\${CASE_GPU_UUID}}, got \${RELAX_POST_GPU_UUID}" >&2
  exit 2
fi
...
unset RELAX_RELION_FINE_DIFF2_FUSED_FFI
unset RELAX_USE_FLOAT64_SCORING RELAX_USE_FLOAT64_PROJECTIONS
$(write_optional_env_exports RELAX_RELION_FINE_DIFF2_FUSED_FFI)
export PYTHONNOUSERSITE=1
export RECOVAR_DISABLE_CUDA=1
export CUDA_VISIBLE_DEVICES=""
...
RELAX_RELION_EM_BATCH_PROJECTION_FRACTION=${RELAX_RELION_EM_BATCH_PROJECTION_FRACTION:-}
RELAX_RELION_FIRSTITER_RECON_COMPLEX_BUDGET=${RELAX_RELION_FIRSTITER_RECON_COMPLEX_BUDGET:-}
RELAX_PASS1_FUSED=${RELAX_PASS1_FUSED:-}
RELAX_DISABLE_LOCAL_BIG_JIT=${RELAX_DISABLE_LOCAL_BIG_JIT:-}
RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MAX_IMAGES=${RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MAX_IMAGES:-}
RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MAX_INFLATION=${RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MAX_INFLATION:-}
RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MIN_BUCKET_SIZE=${RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MIN_BUCKET_SIZE:-}
RELAX_SPARSE_PASS2_MAX_TRANSLATION_TILE_BYTES=${RELAX_SPARSE_PASS2_MAX_TRANSLATION_TILE_BYTES:-}
RELAX_SPARSE_PASS2_MAX_PROJECTION_GATHER_BYTES=${RELAX_SPARSE_PASS2_MAX_PROJECTION_GATHER_BYTES:-}
RELAX_SPARSE_PASS2_MAX_NOISE_BLOCK_BYTES=${RELAX_SPARSE_PASS2_MAX_NOISE_BLOCK_BYTES:-}
RELAX_SPARSE_PASS2_MAX_ADJOINT_BLOCK_BYTES=${RELAX_SPARSE_PASS2_MAX_ADJOINT_BLOCK_BYTES:-}
RELAX_SPARSE_PASS2_PROJECTION_CACHE_MAX_BYTES=${RELAX_SPARSE_PASS2_PROJECTION_CACHE_MAX_BYTES:-}
RELAX_SPARSE_PASS2_MAX_PROJECTED_ROTATIONS=${RELAX_SPARSE_PASS2_MAX_PROJECTED_ROTATIONS:-}
RELAX_K1_DENSE_PASS2=${RELAX_K1_DENSE_PASS2:-}
RELAX_K1_SKIP_SIGNIFICANCE_PRUNING=${RELAX_K1_SKIP_SIGNIFICANCE_PRUNING:-}
RELAX_K1_RELION_X_HALF_MSTEP=${RELAX_K1_RELION_X_HALF_MSTEP:-}
RELAX_RELION_X_HALF_MSTEP_DOUBLE=${RELAX_RELION_X_HALF_MSTEP_DOUBLE:-}
RELAX_RELION_FINE_DIFF2_FUSED_FFI=${RELAX_RELION_FINE_DIFF2_FUSED_FFI:-}
RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE=${RELAX_FINAL_ALL_DATA_REPLAY_LAST_NUMBERED_STATE:-}
RELAX_FINAL_ALL_DATA_USE_MERGED_REFERENCE=${RELAX_FINAL_ALL_DATA_USE_MERGED_REFERENCE:-}
RELAX_FINAL_ALL_DATA_DISABLE_REPLAY_LAST_NUMBERED_STATE=${RELAX_FINAL_ALL_DATA_DISABLE_REPLAY_LAST_NUMBERED_STATE:-}
RELAX_FINAL_ALL_DATA_GRID_CORRECT=${RELAX_FINAL_ALL_DATA_GRID_CORRECT:-}
RELAX_INITIAL_PROJECTOR_USE_REAL_REFERENCE=${RELAX_INITIAL_PROJECTOR_USE_REAL_REFERENCE:-}
RELAX_FIRSTITER_CC_TREE_TOP2_RESCORE_MAX_MARGIN=${RELAX_FIRSTITER_CC_TREE_TOP2_RESCORE_MAX_MARGIN:-}
RELAX_LOCAL_ADAPTIVE_PASS2_FULL_PARENT=${RELAX_LOCAL_ADAPTIVE_PASS2_FULL_PARENT:-}
RELAX_LOCAL_ADAPTIVE_PASS2_ROTATION_ONLY=${RELAX_LOCAL_ADAPTIVE_PASS2_ROTATION_ONLY:-}
RELAX_LOCAL_ADAPTIVE_PASS2_DENOMINATOR_SUPPORT=${RELAX_LOCAL_ADAPTIVE_PASS2_DENOMINATOR_SUPPORT:-}
RELAX_BPREF_ACCUM_DUMP_DIR=${RELAX_BPREF_ACCUM_DUMP_DIR:-}
RELAX_BPREF_CONTRIBUTION_DUMP_DIR=${RELAX_BPREF_CONTRIBUTION_DUMP_DIR:-}
...
RELAX_K1_BPREF_EXECUTION_ORDER_CHUNK_SIZE=${RELAX_K1_BPREF_EXECUTION_ORDER_CHUNK_SIZE:-}
RELAX_K1_RELION_EXACT_TRANSLATION_GRID=${RELAX_K1_RELION_EXACT_TRANSLATION_GRID:-}
RELAX_K1_RELION_POWERCLASS_SPECTRUM_NORM=${RELAX_K1_RELION_POWERCLASS_SPECTRUM_NORM:-}
RELAX_K1_RELION_EXACT_BPREF_OPERANDS=${RELAX_K1_RELION_EXACT_BPREF_OPERANDS:-}
RELAX_K1_RELION_LIVE_INITIAL_NOISE=${RELAX_K1_RELION_LIVE_INITIAL_NOISE:-}
...
RELAX_MSTEP_DUMP_RAW=${RELAX_MSTEP_DUMP_RAW:-}
RELAX_SAVE_INTERMEDIATES_DIR=${RELAX_SAVE_INTERMEDIATES_DIR:-}
RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED=${RELAX_SAVE_INTERMEDIATES_SKIP_UNREGULARIZED:-}
RELAX_RELION_CURRENT_SIZES=${RELAX_RELION_CURRENT_SIZES:-}
RELION_DUMP_DIR=${RELION_DUMP_DIR:-}
RELION_DUMP_STACK_INDEX=${RELION_DUMP_STACK_INDEX:-}
RELION_DUMP_PART_ID=${RELION_DUMP_PART_ID:-}
