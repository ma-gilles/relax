...
from relax.diagnostics.compact_candidate_capture import SCHEMA as PRODUCTION_CAPTURE_SCHEMA
from relax.diagnostics.compact_candidate_capture import validate_raw_capture_shard
