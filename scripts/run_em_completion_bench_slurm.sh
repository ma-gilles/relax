...
#
# This is the heavyweight EM-only evidence run required by relax/AGENTS.md:
...
RELAX_SPARSE_KCLASS_GROUP_TIMING="${RELAX_SPARSE_KCLASS_GROUP_TIMING:-1}"
...
Environment overrides:
  ...
  RELAX_SPARSE_KCLASS_COMPACT_BUCKETS
  ...
  RELAX_SPARSE_KCLASS_COMPACT_PAIRS_MIN_BUCKET_SIZE
                             Optional compact-pair hybrid threshold; lower pair buckets stay rectangular
  RELAX_SPARSE_KCLASS_COMPACT_PAIRS_THRESHOLD_REPORT
                             Optional compact-pair hybrid threshold report list, e.g. "8192,16384,65536"; set 0 to suppress
  RELAX_SPARSE_KCLASS_COMPACT_ACTIVE_ROWS
                             Optional compact-pair active-row backprojection experiment flag
  RELAX_SPARSE_KCLASS_COMPACT_PAIR_STATS
                             Optional compact-pair diagnostic planner flag; set 0 for speed A/B runs
  RELAX_SPARSE_KCLASS_GROUP_TIMING
                             Coarse fused K-class bucket-group timing diagnostics (default: ${RELAX_SPARSE_KCLASS_GROUP_TIMING})
  RELAX_SPARSE_KCLASS_WINDOWED_TRANSLATION_TILE_CAP
                             Optional fused K-class tile sizing against active score/recon windows
  RELAX_SPARSE_KCLASS_RECTANGULAR_ACTIVE_ROWS
  ...
  RELAX_SPARSE_KCLASS_RECTANGULAR_ACTIVE_PREMATMUL
  ...
  RELAX_SPARSE_KCLASS_ACTIVE_ROW_PAD_MULTIPLE
                             Optional active-row gather padding multiple for stable JIT shapes
  RELAX_K_CLASS_DENSE_PASS2_SUPPORT_FRACTION
                             Optional K-class dense-pass2 fallback median-support threshold
  RELAX_K_CLASS_DENSE_PASS2_MEAN_SUPPORT_FRACTION
  ...
  RELAX_RELION_FIRSTITER_RECON_COMPLEX_BUDGET
                             Optional firstiter_cc reconstruction-tile complex-value cap for 80GB debug speed probes
  RELAX_PASS1_FUSED        Optional pass-1 fused significance validation flag
...
write_job_preamble() {
  ...
  local optional_env_names=(
    ...
    RELAX_SPARSE_PASS2_SMALL_BUCKET_THRESHOLD
    RELAX_SPARSE_PASS2_MAX_HYPOTHESES
    RELAX_SPARSE_PASS2_SCORE_ONLY_MAX_HYPOTHESES
    RELAX_SPARSE_PASS2_MAX_PROJECTED_ROTATIONS
    RELAX_SPARSE_PASS2_PROJECTION_CACHE_MAX_BYTES
    RELAX_SPARSE_PASS2_MAX_PROJECTION_GATHER_BYTES
    RELAX_SPARSE_PASS2_MAX_NOISE_BLOCK_BYTES
...
for env_name in ${optional_env_names[*]} RELAX_SPARSE_KCLASS_FUSED; do
  env_value="\${!env_name-}"
  if [[ -n "\${env_value}" ]]; then
...
if [[ "${RUN_K4_FUSED_SPARSE_PASS2}" -eq 1 ]]; then
  export RELAX_SPARSE_KCLASS_FUSED=1
else
  export RELAX_SPARSE_KCLASS_FUSED=0
fi
echo "RELAX_SPARSE_KCLASS_FUSED=\${RELAX_SPARSE_KCLASS_FUSED}"
nvidia-smi --query-gpu=timestamp,index,name,memory.used,memory.total,utilization.gpu --format=csv -l 60 > "\${OUTPUT_DIR}/gpu_monitor.csv" &
MONITOR_PID="\$!"
trap 'kill "\${MONITOR_PID}" 2>/dev/null || true' EXIT
...
RELAX_SPARSE_PASS2_SMALL_BUCKET_MAX_TRANSLATION_TILE_BYTES=${RELAX_SPARSE_PASS2_SMALL_BUCKET_MAX_TRANSLATION_TILE_BYTES:-}
RELAX_SPARSE_PASS2_SMALL_BUCKET_THRESHOLD=${RELAX_SPARSE_PASS2_SMALL_BUCKET_THRESHOLD:-}
RELAX_SPARSE_PASS2_MAX_HYPOTHESES=${RELAX_SPARSE_PASS2_MAX_HYPOTHESES:-}
RELAX_SPARSE_PASS2_SCORE_ONLY_MAX_HYPOTHESES=${RELAX_SPARSE_PASS2_SCORE_ONLY_MAX_HYPOTHESES:-}
...
RELAX_SPARSE_KCLASS_COMPACT_PAIR_STATS=${RELAX_SPARSE_KCLASS_COMPACT_PAIR_STATS:-}
RELAX_SPARSE_KCLASS_COMPACT_PAIRS=${RELAX_SPARSE_KCLASS_COMPACT_PAIRS:-}
RELAX_SPARSE_KCLASS_REUSE_COMPACT_NOISE_SUMS=${RELAX_SPARSE_KCLASS_REUSE_COMPACT_NOISE_SUMS:-}
RELAX_SPARSE_KCLASS_FUSE_COMPACT_IMAGE_SUMS=${RELAX_SPARSE_KCLASS_FUSE_COMPACT_IMAGE_SUMS:-}
RELAX_SPARSE_KCLASS_COMPACT_PAIR_MSTEP=${RELAX_SPARSE_KCLASS_COMPACT_PAIR_MSTEP:-}
RELAX_SPARSE_KCLASS_COMPACT_PAIR_MAX_IMAGES_PER_MICROBATCH=${RELAX_SPARSE_KCLASS_COMPACT_PAIR_MAX_IMAGES_PER_MICROBATCH:-}
RELAX_SPARSE_KCLASS_COMPACT_PAIR_TAIL_COALESCE_MAX_IMAGES=${RELAX_SPARSE_KCLASS_COMPACT_PAIR_TAIL_COALESCE_MAX_IMAGES:-}
RELAX_SPARSE_KCLASS_COMPACT_PAIR_TAIL_COALESCE_MAX_INFLATION=${RELAX_SPARSE_KCLASS_COMPACT_PAIR_TAIL_COALESCE_MAX_INFLATION:-}
RELAX_SPARSE_KCLASS_COMPACT_PAIR_TAIL_COALESCE_MIN_BUCKET_SIZE=${RELAX_SPARSE_KCLASS_COMPACT_PAIR_TAIL_COALESCE_MIN_BUCKET_SIZE:-}
RELAX_SPARSE_KCLASS_COMPACT_PAIRS_MIN_BUCKET_SIZE=${RELAX_SPARSE_KCLASS_COMPACT_PAIRS_MIN_BUCKET_SIZE:-}
RELAX_SPARSE_KCLASS_COMPACT_PAIRS_THRESHOLD_REPORT=${RELAX_SPARSE_KCLASS_COMPACT_PAIRS_THRESHOLD_REPORT:-}
RELAX_SPARSE_KCLASS_COMPACT_ACTIVE_ROWS=${RELAX_SPARSE_KCLASS_COMPACT_ACTIVE_ROWS:-}
RELAX_SPARSE_KCLASS_COMPACT_BUCKETS=${RELAX_SPARSE_KCLASS_COMPACT_BUCKETS:-}
RELAX_SPARSE_KCLASS_GROUP_TIMING=${RELAX_SPARSE_KCLASS_GROUP_TIMING:-}
RELAX_SPARSE_KCLASS_WINDOWED_TRANSLATION_TILE_CAP=${RELAX_SPARSE_KCLASS_WINDOWED_TRANSLATION_TILE_CAP:-}
RELAX_SPARSE_KCLASS_RECTANGULAR_ACTIVE_ROWS=${RELAX_SPARSE_KCLASS_RECTANGULAR_ACTIVE_ROWS:-}
RELAX_SPARSE_KCLASS_RECTANGULAR_ACTIVE_ROWS_MIN_BUCKET_SIZE=${RELAX_SPARSE_KCLASS_RECTANGULAR_ACTIVE_ROWS_MIN_BUCKET_SIZE:-}
RELAX_SPARSE_KCLASS_RECTANGULAR_ACTIVE_PREMATMUL=${RELAX_SPARSE_KCLASS_RECTANGULAR_ACTIVE_PREMATMUL:-}
RELAX_SPARSE_KCLASS_RECTANGULAR_ACTIVE_PREMATMUL_MAX_GROUPED_DENSE_RATIO=${RELAX_SPARSE_KCLASS_RECTANGULAR_ACTIVE_PREMATMUL_MAX_GROUPED_DENSE_RATIO:-}
RELAX_SPARSE_KCLASS_ACTIVE_ROW_PAD_MULTIPLE=${RELAX_SPARSE_KCLASS_ACTIVE_ROW_PAD_MULTIPLE:-}
RELAX_K_CLASS_DENSE_PASS2_SUPPORT_FRACTION=${RELAX_K_CLASS_DENSE_PASS2_SUPPORT_FRACTION:-}
RELAX_K_CLASS_DENSE_PASS2_MEAN_SUPPORT_FRACTION=${RELAX_K_CLASS_DENSE_PASS2_MEAN_SUPPORT_FRACTION:-}
RELAX_K_CLASS_DENSE_PASS2_SMALL_DATASET_IMAGES=${RELAX_K_CLASS_DENSE_PASS2_SMALL_DATASET_IMAGES:-}
RELAX_K_CLASS_DENSE_PASS2_SMALL_DATASET_MEAN_SUPPORT_FRACTION=${RELAX_K_CLASS_DENSE_PASS2_SMALL_DATASET_MEAN_SUPPORT_FRACTION:-}
RELAX_SPARSE_KCLASS_FUSED=${RELAX_SPARSE_KCLASS_FUSED:-}
