...
| long | `pixi run test-long` | about 6 h wall on H100 (7 h on A100), 4 GPUs | one Slurm job, 4 GPUs | the EM long tier (K1 50k/256 standalone and seeded, native VDAM, K4 50k/256) and the K1 (standalone) and K4 100k/256 completions, masked and unmasked, against RELION repeat bands |
...
| Arm | H100 (14410744, relax 93ce1aa) | A100 (14375361, relax 319cd10) |
| --- | --- | --- |
| whole tier | 366 min | 425 min |
| K4 100k/256 completion | 354 min | 413 min |
| K1 100k/256 completion | 154 min | 197 min |
| K4 50k/256 Class3D | 184 min | 91 min |
| K1 50k/256 standalone | 105 min | 172 min |
| K1 50k/256 RELION-seeded | 75 min | 201 min |
| EMPIAR-10097 hp3 replay (default / resident) | 31 / 11 min | - |
| native VDAM 50k | 4 min | 4 min |

The K4 completion bounds the tier on both models. The K4 50k arm grew after Class3D became
standalone by default (two arms, standalone and RELION-seeded debug). The planner's
`LONG_ARM_SECONDS` are the H100 walls. Tier and
