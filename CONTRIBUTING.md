...
| baseline regeneration | `pixi run regen-fixture-manifest`, `pixi run regen-pinned-fast` | - | - | the fixture manifest and the pinned relax outputs; only on the user's explicit request |
