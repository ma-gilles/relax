...
from relax.scoring.coarse_device_selection import DeviceCoarseBlockSelection
...
def _compute_coarse_gaussian_gemm_hybrid_batch(
    ...
    *,
    ...
    from relax.scoring.coarse_gemm_hybrid import validate_coarse_gemm_certificate_topology
    ...
    if score_representation == "dense_full_direct_static_capacity":
        ...
        from relax.scoring.coarse_device_rescore import RESCORE_REASONS, rescore_coarse_rotation_blocks
