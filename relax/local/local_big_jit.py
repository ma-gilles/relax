...
from relax.helpers.deterministic_reduce import add_segment_sum, deterministic_reductions_enabled
...
from relax.local.flat_local_rows import scatter_flat_local_rows
...
def _relion_wavg_direct_triplet_shells(
    ...
    *,
    ...
    if native_prefix:
        ...
        from relax.sparse_pass2.sparse_pass2_wavg import _relion_wavg_rectangle_image_power
...
def _compute_native_noise_residual(
    ...
    from relax.cuda.noise_residual import residual_statistics
