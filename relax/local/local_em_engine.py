...
from relax.helpers.env_flags import parse_env_binary_flag, parse_env_nonnegative_int, parse_env_true_flag
...
from relax.helpers.fourier_window import STABLE_FOURIER_WINDOW_QUANTUM_ENV as STABLE_FOURIER_WINDOW_QUANTUM_ENV
...
from relax.helpers.image_shifts import integer_pre_shifts_or_none, tiled_half_image_phase_factors
from relax.helpers.normalization_inputs import prepare_local_normalization_inputs
from relax.helpers.preprocessing import half_translation_phase_table as _half_translation_phase_table
...
from relax.helpers.projection import compute_noise_block as _compute_noise_block
from relax.helpers.projection import compute_norm_residual_per_image as _compute_norm_residual_per_image
...
from relax.helpers.projection import indexed_projection_available as _indexed_projection_available
from relax.helpers.projection import relion_scale_correction_pixel_mask as _relion_scale_correction_pixel_mask
from relax.helpers.scale_groups import prepare_scale_correction_groups
from relax.helpers.shape_buckets import pad_axis
from relax.helpers.timing import block_until_ready as _block_until_ready
...
from relax.local import fixed_capacity_local, local_preprocessing
from relax.local import local_projection_cache as projection_cache
from relax.local.fixed_capacity_local import _FixedCapacityLocalExecutionBundle
from relax.local.flat_local_rows import (
...
from relax.local.local_physical_grid import (
...
from relax.local.local_score_pass import (
...
from relax.local.local_timing import (
    LocalBucketProgress,
...
def run_local_em_exact(
    ...
    *,
    ...
    if projector_capacity_enabled:
        from relax.helpers.projection import prepare_relion_projector_capacity
                ...
                if return_deferred_source_vdam_operands:
                    ...
                    if packed_final_noise_enabled:
                        ...
                        if host_plan_pack_enabled:
                            from relax.helpers.deferred_vdam_host_pack import pack_deferred_vdam_host_plan
                            if host_plan_cuda_enabled:
                                from relax.helpers.deferred_vdam_host_pack import (
