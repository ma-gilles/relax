...
EXACT_LOCAL_RAW_CACHE_MAX_GB_ENV = "RELAX_EXACT_LOCAL_RAW_CACHE_MAX_GB"

EXACT_LOCAL_PROCESSED_HALF_CACHE_MAX_GB = 0.0
EXACT_LOCAL_PROCESSED_HALF_CACHE_MAX_GB_ENV = "RELAX_EXACT_LOCAL_PROCESSED_HALF_CACHE_MAX_GB"

EXACT_LOCAL_SPARSE_BIG_JIT_MSTEP_MAX_GB = 12.0
EXACT_LOCAL_SPARSE_BIG_JIT_MSTEP_MAX_GB_ENV = "RELAX_EXACT_LOCAL_SPARSE_BIG_JIT_MSTEP_MAX_GB"
