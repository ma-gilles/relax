...
from relax.diagnostics.initial_model_capture import (
...
_KCLASS_EXACT_FINE_ENV = "RELAX_INITIAL_MODEL_KCLASS_EXACT_FINE"


_STABLE_FLAT_ROW_CAPACITY_ENV = "RELAX_INITIAL_MODEL_STABLE_FLAT_ROW_CAPACITY"


_PACKED_LOCAL_PROJECTION_ENV = "RECOVAR_INITIAL_MODEL_PACKED_LOCAL_PROJECTION"


_FUSED_PAIR_FINE_SCORE_ENV = "RELAX_EXACT_LOCAL_FUSED_PAIR_FINE_SCORE"


_DEFER_PACKED_VDAM_ENV = "RECOVAR_INITIAL_MODEL_DEFER_PACKED_VDAM"


_PACKED_FINAL_NOISE_ENV = "RELAX_INITIAL_MODEL_PACKED_FINAL_NOISE"


_UNIFY_LOCAL_BUCKET_SIZES_ENV = "RELAX_INITIAL_MODEL_UNIFY_LOCAL_BUCKET_SIZES"
...
def _run_sparse_pass2_initial_model_estep(
    ...
    *,
    ...
    coarse_gemm_diagnostic_requested = bool(
        os.environ.get("RELAX_COARSE_GAUSSIAN_GEMM_DIAGNOSTIC_DIR", "").strip()
        or os.environ.get(
    ...
    for processing_index, (
        ...
        t0 = time.time()
        from relax.sparse_pass2 import sparse_pass2_posterior as sparse_diagnostics
