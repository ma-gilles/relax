...
from relax.sparse_pass2.sparse_pass2_budget import _dtype_itemsize
...
def _compact_pair_weighted_rotation_and_image_sums_native(
    ...
    from relax.cuda.kernels import dual_weighted_sums_pairs_f32
...
def _compact_pair_weighted_sums_and_noise_native_flat_rows(
    ...
    *,
    ...
    """
    from relax.cuda.kernels import dual_weighted_sums_pairs_rows_f32
