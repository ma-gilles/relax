...
from relax.diagnostics.chunk_profile import SparseChunkProfile
from relax.diagnostics.compact_candidate_capture import (
...
from relax.helpers.batch_fetch import fetch_indexed_batch, original_image_indices, prefetched_batches
...
from relax.helpers.preprocessing import half_translation_phase_table, prepare_batch_preprocess_operands
...
from relax.scoring.compact_candidates import _candidate_mask_count
...
from relax.sparse_pass2 import firstiter_bpref, sparse_pass2_projection_blocks
from relax.sparse_pass2.sparse_pass2_adjoint import (
...
from relax.sparse_pass2.sparse_pass2_bucket_plan import (
    _bucket_group_stats,
    _bucket_summary,
...
from relax.sparse_pass2.sparse_pass2_compact_pair_sums import (
...
from relax.sparse_pass2.sparse_pass2_noise_blocks import (
    ...
    if use_relion_projector:
        ...
        if relion_projector_texture is not None:
            ...
            if not use_float64_scoring and relion_projector_half.dtype == jnp.complex128:
                ...
                # (AccProjector::setMdlData); the dispatcher's persistent texture
                # and the coarse scorer narrow this slab the same way. Left as
                # complex128, this path (reached when the slab arrives as a
                # device array, e.g. a start from RELION's saved state) dropped
                # onto the vmapped JAX fallback: other values than the
                # standalone path, and 15% of a warm hp3 iteration.
...
def compute_k_class_pass2_stats_sparse_fused(
    ...
    *,
    ...
    from relax.sparse_pass2.sparse_pass2_policy import deferred_host_statistics_mode, sparse_kclass_pipeline_depth
