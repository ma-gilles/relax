...
from relax.helpers.fourier_window import make_fourier_window_indices_np, relion_fftw_order_for_square_score_window
...
def _relion_wavg_add_triplet_pixels_chunked(
    ...
    *,
    ...
    from relax.cuda.kernels import relion_wavg_rotation_atomic_triplet_add_f32
