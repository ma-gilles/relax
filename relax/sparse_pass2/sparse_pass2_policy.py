...
from relax.helpers.env_flags import parse_env_flag, parse_env_nonnegative_int
...
_SMALL_BUCKET_COALESCE_SIZE_ENV = "RELAX_SPARSE_PASS2_SMALL_BUCKET_COALESCE_SIZE"


_AUTO_SMALL_BUCKET_COALESCE_MAX_IMAGES_ENV = "RELAX_SPARSE_PASS2_AUTO_SMALL_BUCKET_COALESCE_MAX_IMAGES"


_TAIL_BUCKET_COALESCE_MAX_IMAGES_ENV = "RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MAX_IMAGES"


_TAIL_BUCKET_COALESCE_MAX_INFLATION_ENV = "RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MAX_INFLATION"


_TAIL_BUCKET_COALESCE_MIN_BUCKET_SIZE_ENV = "RELAX_SPARSE_PASS2_TAIL_BUCKET_COALESCE_MIN_BUCKET_SIZE"


_COMPACT_KCLASS_PAIRS_CHECK_ENV = "RELAX_SPARSE_KCLASS_COMPACT_PAIRS_CHECK"


_SPARSE_KCLASS_COMPACT_PAIRS_ENV = "RELAX_SPARSE_KCLASS_COMPACT_PAIRS"


_SPARSE_KCLASS_COMPACT_PAIR_MAX_IMAGES_ENV = "RELAX_SPARSE_KCLASS_COMPACT_PAIR_MAX_IMAGES_PER_MICROBATCH"


_SPARSE_KCLASS_COMPACT_PAIRS_MIN_BUCKET_SIZE_ENV = "RELAX_SPARSE_KCLASS_COMPACT_PAIRS_MIN_BUCKET_SIZE"
...
_SPARSE_KCLASS_ACTIVE_ROW_PAD_MULTIPLE_ENV = "RELAX_SPARSE_KCLASS_ACTIVE_ROW_PAD_MULTIPLE"


_SPARSE_KCLASS_RESIDUAL_TERMS_FUSED_ENV = "RELAX_SPARSE_KCLASS_RESIDUAL_TERMS_FUSED"


_SPARSE_KCLASS_NATIVE_DUAL_WEIGHTED_SUMS_ENV = (
    "RELAX_SPARSE_KCLASS_NATIVE_DUAL_WEIGHTED_SUMS"
)


_SPARSE_KCLASS_FUSED_MSTEP_NOISE_ENV = "RELAX_SPARSE_KCLASS_FUSED_MSTEP_NOISE"


_SPARSE_KCLASS_COMPACT_PAIR_MSTEP_ENV = "RELAX_SPARSE_KCLASS_COMPACT_PAIR_MSTEP"
...
_PASS2_DUMP_CONSERVATIVE_EXECUTION_ENV = "RELAX_PASS2_DUMP_CONSERVATIVE_EXECUTION"


_NORM_RESIDUAL_DUMP_ONLY_ENV = "RELAX_PASS2_DUMP_NORM_RESIDUAL_ONLY"


_SPARSE_PASS2_PROJECTION_CACHE_ENV = "RELAX_SPARSE_PASS2_PROJECTION_CACHE"


_SPARSE_PASS2_CACHED_SCORE_ROT_CHUNK_ENV = "RELAX_SPARSE_PASS2_CACHED_SCORE_ROT_CHUNK"
...
_SPARSE_PASS2_WINDOWED_TRANSLATION_TILE_MAX_MULTIPLIER_ENV = (
    "RELAX_SPARSE_PASS2_WINDOWED_TRANSLATION_TILE_MAX_MULTIPLIER"
)
...
_SPARSE_KCLASS_GROUP_STATIC_ACTIVE_ROWS_ENV = "RELAX_SPARSE_KCLASS_GROUP_STATIC_ACTIVE_ROWS"
...
def group_static_active_rows_enabled() -> bool:
    ...
    ``RELAX_SPARSE_KCLASS_ACTIVE_ROW_PAD_MULTIPLE``, so it differs between chunks
...
_SPARSE_KCLASS_STABLE_WINDOWS_ENV = "RELAX_SPARSE_KCLASS_STABLE_WINDOWS"
...
_SPARSE_KCLASS_FUSED_CHUNK_ENV = "RELAX_SPARSE_KCLASS_FUSED_CHUNK"
...
def vectorized_stats_replay_enabled() -> bool:
    ...
    return parse_env_flag("RELAX_SPARSE_KCLASS_VECTORIZED_STATS_REPLAY", default=False)
...
def deferred_host_statistics_mode():
    ...
    """
    name = "RELAX_SPARSE_KCLASS_DEFERRED_HOST_STATS"
...
def sparse_kclass_pipeline_depth():
    ...
    depth = parse_env_nonnegative_int("RELAX_SPARSE_KCLASS_PIPELINE_DEPTH")
