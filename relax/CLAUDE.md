...
| `docs/math/em_relion_parity_scorecard_v2.json` (v1 kept as history), `em_k4_class_fsc_auc_scorecard_v1.json`, `vdam_relion_parity_scorecard_v1.json` | The synthetic fixed suites: K=1 34-case (v2 scores final maps with RELION's always-on gridding correction; reference data lost 2026-09-26, see `em_work/LOSS_AUDIT_20260926.md`, numbers kept), K=4 per-iteration per-class, VDAM 12-case | `python scripts/summarize_*_scorecard.py --check docs/math/<file>.md` |
